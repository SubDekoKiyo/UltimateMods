...
//             {
//                 string roleOptions = GameOptionsDataPatch.optionsToString(baseOption, true);
//                 string NameColored = Helpers.cs(pc.GetRoleColor(), pc.GetRoleName());
//                 string FullDescription = pc.GetRoleName() + "Full";
//                 rolesText += $"<size=150%>{NameColored}</size>" + ($"\n{FullDescription}") + "\n\n" + ($"{roleOptions}\n\n");
//             }
