...
namespace UltimateMods.Patches
{
    ...
    public class DisableRecordsAdminPatch
    {
        ...
        {
            if (!CustomOptionsH.EnableRecordsAdmin.getBool() && GameOptionsManager.Instance.currentNormalGameOptions.MapId == 4)
            {
            ...
            if (!CustomOptionsH.EnableCockpitAdmin.getBool() && GameOptionsManager.Instance.currentNormalGameOptions.MapId == 4)
            {
